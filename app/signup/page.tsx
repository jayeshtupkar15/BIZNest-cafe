      ...
      <div className="relative w-full max-w-lg">
        ...
        <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 p-8">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <button className="flex items-center justify-center gap-2 p-3 bg-white/50 border border-white/30 rounded-xl hover:bg-white/70 transition-all duration-200">
