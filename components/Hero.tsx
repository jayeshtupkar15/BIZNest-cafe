...
export default function Hero() {
  return (
    <section
      className="relative text-center py-24 md:py-32 flex flex-col items-center justify-center"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl px-4">
        ...
        <p className="text-base sm:text-lg md:text-xl text-white/90 mb-6">
          At BIZ Nest, come put your mind to the test, and enjoy coffee that's
          truly the best.
        </p>
        <button className="px-6 sm:px-8 py-3 bg-amber-500 hover:bg-amber-600 text-white font-semibold rounded-lg transition">
          Order Now
        </button>
      </div>
    </section>
